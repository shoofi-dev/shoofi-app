...
import OptimizedImage from "../../../components/custom-fast-image";
...
interface GeneralCategoriesListProps {
  categoryList: any[];
  ListHeaderComponent?: React.ReactElement;
  productId?: string;
}

export interface GeneralCategoriesListRef {
...
const GeneralCategoriesList = forwardRef<GeneralCategoriesListRef, GeneralCategoriesListProps>(({ categoryList, ListHeaderComponent, productId }, ref) => {   
  ...
  const handleCategoryPress = (cat) => {
    navigation.navigate("menuGeneralCategoriesScreen", { categoryId: cat._id });
  }
...
export default observer(GeneralCategoriesList);
